...
Inputs.select(new Map([
  ...
  ["lose, ascending", (a, b) => d3.ascending(a.lose, b.lose)],
  ["lose, descending", (a, b) => d3.descending(a.lose, b.lose)]
]), {label: "Order"})
)}
...
FileAttachment("3_2@1.csv").csv({typed: true})
)}
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["3_2@1.csv", {url: new URL("./files/d23c30cf3b0602784f039c28e3068f27e17ae3619dd621ccc4a123fa1b1c7328f9f45871f6f463bfa9246bf3a69c6eccbb9bb70df43486a26ae16fed7a278dc6.csv", import.meta.url), mimeType: "text/csv", toString}]
  ]);
