...
FileAttachment("3_1.csv").csv({typed: true})
)}
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["3_1.csv", {url: new URL("./files/ab934dc090ec025d2a15ea6485aa5f7cd147d1154143d667753383072458df087b769a4d6ff762b364172e672f19f81fbc118647e6fde5194d3167dcad39dfb7.csv", import.meta.url), mimeType: "text/csv", toString}]
  ]);
